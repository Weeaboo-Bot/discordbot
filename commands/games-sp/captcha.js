...
registerFont(path.join(__dirname, '..', '..', 'assets', 'fonts', 'Captcha.ttf'),
             {family : 'Captcha'});
...
module.exports = class CaptchaCommand extends Command {
      ...
      credit : [
        {
          ...
          url :
              'https://www.fontsquirrel.com/fonts/list/foundry/christoph-mueller',
  ...
  async run(msg) {
    ...
    await msg.reply('**You have 15 seconds, what does the captcha say?**', {
      files : [
        {attachment : canvas.toBuffer(), name : 'captcha-quiz.png'},
      ],
    });
    ...
    if (!msgs.size)
      return msg.reply(`Sorry, time is up! It was ${text}.`);
