...
module.exports = class JeopardyCommand extends Command {
        ...
        super(client, {
            ...
            credit: [
                ...
                },
                {
                    ...
                    reasonURL:
                        'https://fontmeme.com/fonts/korinna-agency-font/',
                },
            ],
        });
    }
    ...
    async run(msg) {
        ...
        try {
            ...
            const connection = msg.guild
                ? this.client.voice.connections.get(msg.guild.id)
                : null;
            if (connection) {
                connection.play(
                    path.join(
            ...
            await msg.reply(
                `The category is: **${question.category.title.toUpperCase()}**. 30 seconds, good luck.`,
                {
            ...
            const win =
                msgs.first().content.toLowerCase() === answer.toLowerCase();
