...
module.exports = class CommandTemplate extends Command {
  constructor(client) {
    super(client, {
      ...
      group: "utility",
      args: [
        { key: "arg1", type: "string", prompt: "arg1 Prompt" },
        { key: "arg2", type: "string", prompt: "arg2 Prompt" }, // More Args
      ],
    });
  }
  run(message, { arg1, arg2 }) {
    ...
    await axios.get('URL')
        ...
        .catch(function(err){
            message.client.channels.cache.get(error_log).send({embed:
    errorMessage(err,ErrorEnum.API,message.command.name)});
        });
     */
  }
};
