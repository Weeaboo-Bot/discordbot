...
const mock =
    [ 'I love Emilia!', 'Astolfo is best girl!', 'Traps are not gay!' ];
...
module.exports = class MockCommand extends Command {
  ...
  async run(message, {member, text}) {
    ...
    const hook = await message.channel.createWebhook(name, {
    ...
    setTimeout(async function() { await hook.delete(); }, 1000);
  }
};
