              ...
              new Discord.MessageEmbed()
                  ...
                  .addField('Stock Open: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['1a. open (USD)'])
                  .addField('Stock High: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['2a. high (USD)'])
                  .addField('Stock Low: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['3a. low (USD)'])
                  .addField('Stock Close: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['4a. close (USD)'])
                  .addField('Stock Volume: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['5. volume'])
                  .addField('Stock Market Cap: ',
                            data['Time Series (Digital Currency Daily)']
                                [currDate]['6. market cap (USD)']);
