...
const { fromNow, humanizeDuration } = require('discord.js-commando');
...
module.exports = class BotInfoCommand extends Command {
    ...
    async run(message) {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addField('❯\u2000\Presence', `•\u2000\**Servers:** ${this.client.guilds.cache.size}\n\•\u2000\**Users:** ${this.client.users.cache.size}\n\•\u2000\**Voice Channels:** ${this.client.voiceConnections.cache.size}`, true)
