  ...
  run(message) {
    const embed =
        new Discord.MessageEmbed()
            ...
            .setFooter(
                'Any message from me can be removed by reacting with a 🎴 emoji!')
            .addField(
                '__2D NSFW:__',
                '`ecchi` `hentai` `hentaigif`\n`hentaiirl` `neko` `pantsu`\n`oppai` `yaoi` `yuri` `zr   `',
                true)
            .addField(
                '__2D Fetish:__',
                '`ahegao` `bara` `bondage`\n`futa` `monstergirl` `paizuri`\n`sukebei` `tentacle` `trap`',
                true)
            .addField(
                '__3D NSFW:__',
                '`4knsfw` `artsyporn` `ass` `boobs`\n`nsfw` `nsfwgif` `pornhub` `pussy`',
                true)
            .addField('__3D Fetish:__',
                      '`asian` `amateur` `bdsm`\n`cosplay` `grool` `lingerie`',
                      true)
            .addField(
                '__NSFW Image Boards:__',
                '`danbooru` `gelbooru` `hypno` `konachan` `paheal` `rule34` `tbib` `yandere` `xbooru` `e621`');
