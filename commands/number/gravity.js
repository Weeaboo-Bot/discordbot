...
module.exports = class GravityCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      args : [
        ...
        {
          key : 'planet',
          prompt : `What planet do you want to use as the base? Either ${
              list(Object.keys(planets), 'or')}.`,
          type : 'string',
  ...
  run(msg, {weight, planet}) {
    ...
    return msg.say(`${formatNumber(weight)} kg on ${
        firstUpperCase(planet)} is ${formatNumber(result)} kg.`);
  }
};