...
module.exports = class NickCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description :
          'Assigns a nickname to a member! Use "clear"or leave it blank to remove the nickname!',
