...
module.exports = class KickCommand extends Command {
    ...
    async run(message, {memberName,reason}) {
        ...
        if (member.roles.highest.position > message.member.roles.highest.position - 1) return message.channel.send(`❎ | You can't kick **${member.user.username}**! Their position is higher than you!`);
