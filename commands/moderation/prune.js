            ...
            args: [
                {
                    ...
                    prompt:
                        'Please provide me a set number of messages to prune!',
                    type: 'integer',
                    validate: (count) => {
                ...
                },
                {
                    ...
                    prompt:
                        'Please provide me a valid type of message to prune!',
                    type: 'string',
                    default: 'all',
                    validate: (base) => {
                        if (
    ...
    async run(message, args) {
        ...
        if (type == 'images' || type == 'pics' || type == 'image') {
            try {
                ...
                const m = await message.channel.send(
                    ...
                    }**, successfully pruned **${flushable.size}** ${
                        flushable.size == 1 ? 'image!' : 'images!'
                    }`
                );
        ...
        if (type == 'me') {
            try {
                ...
                await message.channel.bulkDelete(flushable);
                const m = await message.channel.send(
                    `🍇 | **${message.author.username}**, successfully pruned **${flushable.size}** of your messages!`
                );
