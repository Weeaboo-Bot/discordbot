...
module.exports = class PruneUserCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      description :
          'Prunes a specified number of messaged from a specific user!',
