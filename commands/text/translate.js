...
const codes = Object.keys(translate.languages).filter(
    (code) => typeof translate.languages[code] !== 'function'
);
    ...
    constructor(client) {
        super(client, {
            ...
            args: [
                ...
                {
                    key: 'target',
                    prompt: `Which language would you like to translate to? Either ${list(
                        codes,
                        'or'
                    )}.`,
                    type: 'string',
                ...
                {
                    key: 'base',
                    prompt: `Which language would you like to use as the base? Either ${list(
                        Object.keys(codes),
                        'or'
                    )}.`,
                    type: 'string',
                    ...
                    validate: (base) => {
                        ...
                        return `Invalid base, please enter either ${list(
                            codes,
                            'or'
                        )}.`;
                    },
    ...
    async run(msg, { text, target, base }) {
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .addField(
                    `❯ From: ${translate.languages[from.language.iso]}`,
