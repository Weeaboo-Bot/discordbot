...
module.exports = mongoose.model(
    "Guild", new Schema({
      ...
      language : {
        type : String,
        default : config.languages.find((l) => l.default).name
      }, // Language of the guild
      prefix : {
        type : String,
        default : config.prefix
      }, // Default or custom prefix of the guild
      plugins : {
        type : Object,
        default : {
          // Plugins data
          ...
          automod : {
            ...
            ignored :
                [] // The channels in which the auto moderation is disabled
          },
          // Auto sanctions
          warnsSanctions : {
          ...
          suggestions :
              false,       // the channel in which the suggestions will be sent
          modlogs : false, // the channel in which the moderation logs (mute,
                           // kick, ban, etc...) will be sent
          reports : false, // the channel in which the reports will be sent
          fortniteshop : false, // the channel in which the fortnite shop image
                                // will be sent at 2.05am
          logs : false // the channel in which the logs (message deleted,
                       // etc...) will be sent
        }
      },
      slowmode : {
      ...
      ignoredChannels :
          {type : Array, default : []}, // Channels ignored by the bot
      customCommands :
          {type : Array, default : []},        // Custom commands of the guild
      commands : {type : Array, default : []}, // Commands logs
      autoDeleteModCommands : {
        type : Boolean,
        default : false
      }, // Whether to auto delete moderation commands
