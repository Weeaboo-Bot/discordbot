...
module.exports = {
  ...
  support : {
    ...
    logs : "XXXXXXXXXXX", // And the ID of the logs channel of your server (new
                          // servers for example)
  },
  db_pass : process.env.db_pass,
  db_name : process.env.db_name,
  mongoDB :
      `mongodb+srv://dbuser:qadAC5OMGUTlEcFz>@discordcluster.3zyjj.gcp.mongodb.net/discord-bots?retryWrites=true&w=majority`, // The URl of the mongodb database
  ...
  /* The Bot status */
  status : [
    {name : "@Weaboo Bot help on {serversCount} servers", type : "LISTENING"},
  ],
  ...
  languages : [
    {
      ...
      default : true,
      aliases : [ "English", "en", "en-us", "en_us", "en_US" ]
    },
    {
      name : "fr-FR",
      nativeName : "Français",
      ...
      moment : "fr",
      default : false,
      aliases : [ "French", "français", "francais", "fr", "fr_fr" ]
    },
    {
      name : "es-ES",
      nativeName : "Español",
