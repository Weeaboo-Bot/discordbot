...
module.exports = class Util {
    ...
    static garfieldDay(month, year) {
        ...
        if (
            ...
            day =
                Math.floor(
                    Math.random() * (Math.floor(31) - Math.ceil(1) + 1)
                ) + Math.ceil(1);
        } else if (month === 2) {
            if (leapYear(year) === true) {
                day =
                    Math.floor(
                        Math.random() * (Math.floor(29) - Math.ceil(1) + 1)
                    ) + Math.ceil(1);
            } else {
                day =
                    Math.floor(
                        Math.random() * (Math.floor(28) - Math.ceil(1) + 1)
                    ) + Math.ceil(1);
            }
        } else {
            day =
                Math.floor(
                    Math.random() * (Math.floor(30) - Math.ceil(1) + 1)
                ) + Math.ceil(1);
        }
        return day;
    }
