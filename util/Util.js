...
module.exports = class Util {
    ...
    static garfieldDay(month, year) {
        ...
        if(month === 1 || month === 3 || month === 5 || month === 7 || month === 8 || month === 10 || month === 12 ){
            day = Math.floor(Math.random() * (Math.floor(31) - Math.ceil(1) + 1)) + Math.ceil(1);
        } else if (month === 2){
            if(leapYear(year) === true){
                day = Math.floor(Math.random() * (Math.floor(29) - Math.ceil(1) + 1)) + Math.ceil(1);
            } else {
                day = Math.floor(Math.random() * (Math.floor(28) - Math.ceil(1) + 1)) + Math.ceil(1);
            }
        } else {
            day = Math.floor(Math.random() * (Math.floor(30) - Math.ceil(1) + 1)) + Math.ceil(1);
        }
        return day;
    }

    static garfieldURL(day, month, year) {
        let yearURL = 0;
        let garURL = '';
        if (year < 2000){
            yearURL = year - 1900
        ...
        if(yearURL < 10){
            garURL = garURL + 'http://images.ucomics.com/comics/ga/' + year + '/ga' + '0' + yearURL;
        } else {
            garURL = garURL + 'http://images.ucomics.com/comics/ga/' + year + '/ga' + yearURL;
        }
